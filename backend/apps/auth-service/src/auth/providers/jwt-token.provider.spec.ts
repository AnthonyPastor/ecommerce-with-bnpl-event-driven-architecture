...
// Estos tests corren contra el contrato de TokenProviderPort — cualquier
// implementación futura (MercadoPago-like para otros ports, o Auth0/Keycloak
// para este) debería poder pasar la misma batería de casos.
describe('JwtTokenProvider (contrato de TokenProviderPort)', () => {
