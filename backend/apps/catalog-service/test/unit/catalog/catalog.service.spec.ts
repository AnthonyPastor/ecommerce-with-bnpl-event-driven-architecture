...
describe('CatalogService', () => {
  ...
  const product: Product = {
    ...
    imageUrl: null,
    category,
    variants: [{ id: 'var-1', name: 'Black', priceCents: 1000, stock: 5, product: {} as Product }],
    createdAt: new Date(),
    updatedAt: new Date(),
  };
      ...
      items: [
        {
          ...
          variants: [{ id: 'var-1', name: 'Black', priceCents: 1000, stock: 5 }],
        },
      ],
      total: 1,
      page: 1,
  ...
  it('lists categories mapped to DTOs', async () => {
    ...
    expect(result).toEqual([{ id: 'cat-1', name: 'Electronics', slug: 'electronics' }]);
  });
});
