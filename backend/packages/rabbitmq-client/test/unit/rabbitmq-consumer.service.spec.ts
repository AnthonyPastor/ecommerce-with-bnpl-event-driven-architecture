...
import { RabbitMqConsumerService } from '../../src/rabbitmq-consumer.service';
import { CORRELATION_ID_HEADER, RETRY_COUNT_HEADER, TRANSACTION_ID_HEADER } from '../../src/rabbitmq-headers';
